...
impl ProjectPanel {
            ...
            cx.subscribe(
                ...
                move |project_panel, workspace, event, cx| {
                    if let WorkspaceEvent::ActiveItemChanged = event {
                        let new_multi_buffer_entries = workspace
                            .read(cx)
                            .active_item(cx)
                            ...
                            .fold(
                                BTreeMap::new(),
                                |mut entries: BTreeMap<WorktreeId, BTreeSet<ProjectEntryId>>,
    ...
    fn update_visible_entries(
        ...
        // TODO kb use this to change into showing only entries, matching the search query
        dbg!(&self.active_multi_buffer_entries);
